...
## Duke University Fuqua School of Business: MQM Program Data Science for Business Class
## Datacamp 
...
# load data
# data source https://www.kaggle.com/Bideclnnovations/stock-price-and-news-realted-to-it#AppleFlnalData.csv
